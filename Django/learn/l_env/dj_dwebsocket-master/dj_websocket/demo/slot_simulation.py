...
class JackPot:
    ...
    def auto_play(self):
        ...
        # 更新系统收益
        self.my_money += current_play_chip * current_play_line * (1 - self.add_award_percent - self.return_chip)
        # 出奖
        ...
        play_record['my_money'] = self.my_money
...
if __name__ == '__main__':
    ...
    while True:
        result = jp.auto_play()
        print(result)
        print(int(result['user_money'] + result['total_award'] - 400000 + result['my_money']))
        time.sleep(0.3)
else:
    jp = JackPot()